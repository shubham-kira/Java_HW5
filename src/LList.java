...
//        int counter;
    ...
    public void reverse() {
    	...
    	//SWAP THE FIRST AND LAST ELEMENTS ONE BY ONE TILL WE REACH THE MIDDLE ELEMENT IN THE LINKED LIST	
    	 int i, j = numberOfEntries;
         for(i=1; i <= j ; i++,j--)
         	{
         	T temp = this.getEntry(i);
    ...
    public void cycle() {
    	...
    	//CODE TO BE COMPLETED
    	//SWAP THE CONSECUTIVE ELEMENTS ONE BY ONE SO THAT THE FIRST ELEMENT WILL REACH AT THE LAST AND REST WILL SHIFT LEFT BY ONE POSITION
    	int i;
